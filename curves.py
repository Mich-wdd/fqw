...
def quadratic_curve(positions, t, screen, color, curve_list, lin_color=(2, 242, 2), trigger=False):
    ...
    if trigger:
        ...
        a = linear_curve(first_line, t, screen)
        b = linear_curve(second_line, t, screen)

        pygame.draw.line(screen, lin_color, a, b, 2)
        pygame.draw.circle(screen, color, (int(curve[0]), int(curve[1])), 8)
...
def draw_cubic_curve(positions, t, screen, color, curve_list, green, blue, quad_curve, quad_curve1, quad_curve2,
    ...
    a = linear_curve(first_line, t, screen)
    b = linear_curve(second_line, t, screen)
    c = linear_curve(third_line, t, screen)

    quadratic_curve(fourth_line, t, screen, (100, 100, 0), quad_curve)
    quadratic_curve(fifth_line, t, screen, (100, 100, 0), quad_curve1)
    quadratic_curve(sixth_line, t, screen, (100, 100, 0), quad_curve2)
    ...
    start = linear_curve(line1, t, screen)
    end = linear_curve(line2, t, screen)
